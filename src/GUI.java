/**
 * Klasa odpowiedzialna za wyświetlanie planszy oraz komunikatów o grze.
 */
import javax.swing.*;
import java.awt.*;
...
public class GUI extends JFrame {
    ...
    public GUI() throws IOException {
        icon = new ImageIcon("./resources/five.png");
    ...
    public void paintComponents(Graphics g){
        ...
        ImageIcon imageIcon = new ImageIcon(("./resources/tłodobre.png"));
